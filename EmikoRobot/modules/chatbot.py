...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        response = response.replace("I'm married to my job.", "I'm married with @Mss_Rosan_Bot")
        response = response.replace("I'm single.", "My wife is @Mss_Rosan_Bot")
        ...
        test = test.replace("I live in @osmanigroupbot.", "I live in San Francisco, California")
        test = test.replace("I was created by @ribajosmani", "the leader is me")
        test = test.replace(
            "Hello there I am Osmani...nice to meet u",
            "Hi, my friend! Do you want me to tell you a joke?")
...
@pbot.on_message(filters.regex("Osmani|osmani|robot|OSMANI|ribaj") & ~filters.bot & ~filters.via_bot  & ~filters.forwarded & ~filters.reply & ~filters.channel)
async def inuka(client, message):
    msg = message.text
    if msg.startswith("/") or msg.startswith("@"):
        message.continue_propagation()
